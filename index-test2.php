...
// --- ĐOẠN CẬP NHẬT: LƯU URL ĐỂ TỰ ĐỘNG QUAY LẠI SAU KHI ĐĂNG NHẬP / ĐĂNG XUẤT ---
...
// =========================================================================
// NHÂN LỰC (Ẩn tàu đã khóa VÀ ẩn luôn tàu ảo SỰ KIỆN CHUNG)
// =========================================================================
$sql_nhan_luc = "SELECT DISTINCT
                    dr.id as report_id,
                    dr.worker_count,
                    dr.job_content,
                    s.project_name,
...
// =========================================================================
// EVENTS (Ẩn tàu đã khóa VÀ ẩn luôn tàu ảo SỰ KIỆN CHUNG)
// =========================================================================
...
// =========================================================================
// ACTIVE SHIPS (Ẩn tàu đã khóa VÀ ẩn luôn tàu ảo SỰ KIỆN CHUNG)
// =========================================================================
$sql_active_ships = "
SELECT
    s.id,
