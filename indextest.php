...
/* ====================================================
   BACKGROUND SHAPES EFFECT (GIỮ LẠI NỀN TRÔI NỔI CHÌM DƯỚI ĐÁY)
   ==================================================== */
.bg-shape {
    position: fixed;
    z-index: -1;
...
.shape-triangle {
    ...
    border-bottom: 86.6px solid #1e40af;
...
/* ====================================================
   GLASS CARD (ĐÃ XÓA TOÀN BỘ ::BEFORE / ::AFTER ĐỂ GIẢI PHÓNG KHÔNG GIAN)
   ==================================================== */
.glass-card{
    position: relative;
    overflow: hidden;
    ...
    box-shadow:
        ...
        0 2px 5px rgba(15,23,42,0.01);
    will-change: transform;
    transform: translateZ(0);
}

/* Đặt vùng đệm phía trên nhỏ lại để tiêu đề chạm đỉnh */
.panel {
...
/* Căn lề trên chuẩn xác - Không bị gián đoạn dòng chảy */
.panel-header{
    display:flex;
...
.card-status-dang{
    background:linear-gradient(135deg, rgba(255,251,235,0.95), rgba(254,240,138,0.95));
}

.card-status-chua{
    background:linear-gradient(135deg, rgba(253,242,248,0.95), rgba(251,207,232,0.95));
}
...
<script>
// Đăng ký Service Worker với trình duyệt
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('sw.js')
      .then(reg => console.log('App PWA đã sẵn sàng!'))
      .catch(err => console.log('Lỗi đăng ký App:', err));
  });
}
</script>
